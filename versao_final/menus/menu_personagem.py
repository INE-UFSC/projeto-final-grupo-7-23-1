...
class MenuPersonagem(Menu):
    ...
    def display_menu(self):
        ...
        while self.get_run_display():
            ...
            self.get_controlador().draw_text("ESCOLHA SEU", 60, TELA_WIDTH/ 2, 100)
            self.get_controlador().draw_text("PERSONAGEM", 60, TELA_WIDTH/ 2, 180)
            ...
            self.get_controlador().draw_text("Escolhido", 15, self.__p1x + (self.__escolhido - 1) * (self.__p2x - self.__p1x), self.__p1y - 125)
            self.get_controlador().draw_text("Saci-pererê", 25, self.__p1x, self.__p1y + 145)
            self.get_controlador().draw_text("Curupira", 25, self.__p2x, self.__p2y + 145)
            self.get_controlador().draw_text("Personagem 3", 25, self.__p3x, self.__p3y + 145)
